...
(function webpackMissingModule() { throw new Error("Cannot find module \"logs\""); }());
...
_vue2.default.component(_header2.default.name, _header2.default); // 入口文件
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7ba5bd90_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(20);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(17)("c810066a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("mt-header", { attrs: { fixed: "", title: "fixed top" } }),
      _vm._v(" "),
      _c("h1", [_vm._v("123")])
    ],
    1
